...
These planning questions are not yet resolved. They're tracked in doc 06 as "pending decisions":

- AWS budget comfort zone
- Kubernetes strategy (EKS day one vs ECS-first vs local kind)
- Event backbone (SNS/SQS vs Kafka)
- Team size
