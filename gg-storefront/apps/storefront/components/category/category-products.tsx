  ...
  return (
    <div>
      ...
      <div className="mb-6 flex flex-col gap-3 border-b border-border pb-4 sm:flex-row sm:items-center sm:justify-between">
        <p className="font-mono text-[11px] uppercase tracking-[0.1em] text-fg-3">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className={cn(
              ...
              "font-body text-[11px] font-medium uppercase tracking-[0.06em] cursor-pointer",
          ...
          <label className="flex items-center gap-2">
            <span className="font-body text-[11px] uppercase tracking-[0.06em] text-fg-3">
              Sort
            </span>
            <select
              value={sort}
              onChange={(e) => setSort(e.target.value as SortKey)}
              className="clip-cyber-xs border border-border bg-surface px-3 py-[7px] font-body text-[12px] text-fg-1 outline-none transition-colors duration-150 hover:border-border-strong focus:border-primary cursor-pointer"
            >
